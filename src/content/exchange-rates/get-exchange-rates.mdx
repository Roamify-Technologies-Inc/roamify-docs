...
- `from`: optional, The start date for the historical data. This is an optional field of type `string` in ISO 8601 format.
- `to`: optional, The end date for the historical data. This is an optional field of type `string` in ISO 8601 format.
- `interval`: optional, The interval for the historical data. This is an optional field of type `string`. Possible values are `day`, `hour`, `minute`.

<Callout type="warning" emoji="⚠️">
   If datetime was provided, please do not provide from or to or interval parameters.
    OTHERWISE, the API will return an error.
</Callout>

<Callout type="warning" emoji="⚠️">
    If from or to were provided, please also provide interval parameter.
    And please do not provide datetime parameter.
    OTHERWISE, the API will return an error.
</Callout>
